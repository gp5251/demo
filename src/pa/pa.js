...
const ws = fs.createWriteStream("./dist/1.json")
const ws2 = fs.createWriteStream("./dist/2.html")
...
async function main () {
    ...
    for (let i = 0; i < allProject.length; i++){
        ...
        // if ( $(".page-title") && $(".page-title").html() && ( $(".page-title").html().indexOf("The repository for this project is empty") != -1 || 
        // $(".page-title").html().indexOf("This project does not have a README yet") != -1) ) {
        //     return
        // }
        ...
        $(".file-content").html() ? ws2.write($(".file-content").html()) : ws2.write("<br/>--------------null")
        ws2.write("<br/>--------------------------------------------------------------------------------------------------------")
    }
